<x-template title="Delivery Inquries">

    <h1>DELIVERY INQUIRIES</h1>
    <p>By ordering products from this website, you agree to be bound by these Delivery Terms. If you do not agree with any of these Delivery Terms, do not use or order products from this website.</p>
    <h5>WHAT IS THE DELIVERY TIME?</h5>
    <p>Your order will be delivered within 2 - 5 business days (Jabodetabek Area) or 4 - 14 days for other area depending on your delivery address.</p>
    <h5>CAN I DELIVER GOODS OUT OF INDONESIA?</h5>
    <p>Our online shop will only ship within Indonesia</p>
